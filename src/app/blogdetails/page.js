            ...
            <div className="entry__blog">
              <div className="blog__post--header mb-30">
                ...
                <p className="blog__post--meta">
                  Posted by : admin / On : February 04, 2022 / In :{" "}
                  <Link
              ...
              <div className="blog__thumbnail mb-30">
                <img
                  ...
                  src="/img/blog/blog-page-big1.webp"
                  alt="blog-img"
                />
              </div>
              <div className="blog__details--content">
                ...
                <p className="blog__details--content__desc mb-20">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Expedita in recusandae sit officia ipsa, natus ad voluptatem
                  doloribus dolorum placeat, rem deleniti est accusamus ipsum
                  corporis voluptates soluta totam maiores nostrum reprehenderit
                  quasi? Laboriosam itaque ab odit harum sed aut voluptates,
                  illum unde. Saepe enim ad ut pariatur doloremque quas harum
                  sequi, excepturi tempore exercitationem suscipit quam
                  recusandae corrupti quibusdam. Laboriosam sapiente provident
                  repellat blanditiis ratione nostrum illum asperiores quo
                  cumque in quisquam, non iste aut illo vel, alias debitis!
                </p>
                <p className="blog__details--content__desc mb-30">
                  ...
                  necessitatibus nulla accusantium voluptatem ipsum voluptatum,
                  vero in impedit nobis cupiditate ea, dicta eos facilis eaque
                  optio laudantium non neque itaque? Possimus officia aut
                  accusamus illum, adipisci, nihil numquam minus eum fugit,
                  beatae minima facilis magni.
                </p>
                ...
                <p className="blog__details--content__desc">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Voluptatibus sapiente omnis sunt labore mollitia, quaerat
                  incidunt sequi, ut alias accusamus nostrum magni fugit facilis
                  dignissimos illum repellendus et numquam adipisci quos. Eos
                  omnis maiores beatae cum a consequatur magnam sequi neque, at
                  numquam qui ipsam unde veritatis voluptates quam dicta! Ipsam,
                  mollitia illo fuga vel culpa reprehenderit quisquam maxime
                  nesciunt. Sunt quaerat inventore aspernatur quibusdam corrupti
                  numquam mollitia exercitationem rem alias consectetur hic
                  iusto dignissimos nostrum odio, cumque impedit.
                </p>
              </div>
            </div>
                ...
                <li className="widget__categories--menu__list">
                  <label className="widget__categories--menu__label d-flex align-items-center">
                    <img
                      ...
                      src="/img/product/small-product1.webp"
                      alt="categories-img"
                    />
                  ...
                  <ul className="widget__categories--sub__menu">
                    <li className="widget__categories--sub__menu--list">
                      ...
                      >
                        <img
                          ...
                          src="/img/product/small-product2.webp"
                          alt="categories-img"
                        />
                    ...
                    <li className="widget__categories--sub__menu--list">
                      ...
                      >
                        <img
                          className="widget__categories--sub__menu--img"
                          src="/img/product/small-product3.webp"
                          alt="categories-img"
                        />
                        <span className="widget__categories--sub__menu--text">
                          Woolend Jacket
                    ...
                    <li className="widget__categories--sub__menu--list">
                      ...
                      >
                        <img
                          className="widget__categories--sub__menu--img"
                          src="/img/product/small-product4.webp"
                          alt="categories-img"
                        />
                        <span className="widget__categories--sub__menu--text">
                          Western denim
                    ...
                    <li className="widget__categories--sub__menu--list">
                      ...
                      >
                        <img
                          className="widget__categories--sub__menu--img"
                          src="/img/product/small-product5.webp"
                          alt="categories-img"
                        />
                        <span className="widget__categories--sub__menu--text">
                          Mini Dresss
                  ...
                  <div className="articl__post--items__content">
                    <h4 className="articl__post--items__content--title">
                      <Link href="blog-details">
                        The Greatest Teams Favorite Leggings.
                      </Link>
                    </h4>
