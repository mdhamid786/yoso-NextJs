      ...
      <div className="contact__info border-radius-10">
                ...
                <div className="contact__info--items__inner d-flex">
                  ...
                  <div className="contact__info--content">
                    <p className="contact__info--content__desc text-white">
                      ...
                      <Link href="tel:+01234-567890">+01234-567890</Link>{" "}
              ...
              <div className="contact__info--items">
                ...
                <div className="contact__info--items__inner d-flex">
                  ...
                  <div className="contact__info--content">
                    <p className="contact__info--content__desc text-white">
                      {" "}
                      <Link href="mailto:yatasindia.customercare@gmail.com">
                      yatasindia.customercare@gmail.com
                     </Link>{" "}
                      <br />{" "}
                      <Link href="mailto:yatasindia.customercare@gmail.com">yatasindia.customercare@gmail.comm</Link>
                    </p>
                  </div>
                </div>
              </div>
              <div className="contact__info--items">
                ...
                <div className="contact__info--items__inner d-flex">
                  ...
                  <div className="contact__info--content">
                    <p style={{textAlign:"justify"}} className="contact__info--content__desc text-white">
                      {" "}
                      FIRST FLOOR , R-31, VANI VIHAR , BACK SIDE, WEST DELHI, UTTAM NAGAR, DELHI - 110059
                    </p>
                  </div>
                </div>
              </div>
