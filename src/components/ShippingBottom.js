...
const ShippingBottom = () => {
  return (
    <>
      <section className="shipping__section shipping__style2 section--padding color-scheme-2">
  <div className="container">
    <div className="shipping__style2--inner border-radius-10 d-flex justify-content-between">
      <div className="shipping__style2--items d-flex align-items-center">
        <div className="shipping__style2--icon">
          <svg
        ...
        <div className="shipping__style2--content">
          <h2 className="shipping__style2--content__title">SECURE SHOPPING</h2>
          <p className="shipping__style2--content__desc">
            Free order over $300
          </p>
        </div>
      </div>
      <div className="shipping__style2--items d-flex align-items-center">
          ...
          >
            <g id="fast-delivery" transform="translate(0 -59.798)">
              <g
                id="Group_120"
                data-name="Group 120"
                transform="translate(6.111 65.92)"
              >
                <g
                  id="Group_119"
                  data-name="Group 119"
              ...
              <g
                id="Group_122"
                data-name="Group 122"
                transform="translate(12.594 71.137)"
              >
                <g
                  id="Group_121"
                  data-name="Group 121"
              ...
              <g
                id="Group_126"
                data-name="Group 126"
                transform="translate(1.535 64.277)"
              >
                <g
                  id="Group_125"
                  data-name="Group 125"
              ...
              <g
                id="Group_128"
                data-name="Group 128"
                transform="translate(6.889 80.101)"
              >
                <g
                  id="Group_127"
                  data-name="Group 127"
              ...
              <g
                id="Group_130"
                data-name="Group 130"
                transform="translate(25.315 80.103)"
              >
              ...
              <g
                id="Group_132"
                data-name="Group 132"
                transform="translate(3.238 67.033)"
              >
                <g
                  id="Group_131"
                  data-name="Group 131"
              ...
              <g
                id="Group_134"
                data-name="Group 134"
                transform="translate(24.791 72.095)"
              >
                <g
                  id="Group_133"
                  data-name="Group 133"
        ...
        <div className="shipping__style2--content">
          <h2 className="shipping__style2--content__title">ACCEPT PAYMENT</h2>
          <p className="shipping__style2--content__desc">
            Visa, Paypal, Master
          </p>
        </div>
      ...
      <div className="shipping__style2--items d-flex align-items-center">
        ...
        <div className="shipping__style2--content">
          <h2 className="shipping__style2--content__title">30 DAY RETURN</h2>
          <p className="shipping__style2--content__desc">30 day guarantee</p>
        </div>
      </div>
      <div className="shipping__style2--items d-flex align-items-center">
        <div className="shipping__style2--icon">
        ...
        <div className="shipping__style2--content">
          <h2 className="shipping__style2--content__title">24/7 SUPPORT</h2>
          <p className="shipping__style2--content__desc">Support every time</p>
        </div>
      </div>
    </div>
  </div>
