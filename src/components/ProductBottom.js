      ...
      <div className="row">
        <div className="col-xl-8 col-12 product__col--width__8">
          <div className="product__section--wrapper">
            <div className="section__heading style2 position__relative border-bottom mb-35">
              ...
              <img
                className="section__heading--position__img"
                src="/img/other/heading-shape-img.webp"
                alt="heading-shape-img"
              />
            </div>
              ...
              <div className="row row-cols-xxl-4 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n25">
                <div className="col mb-25">
                  <div className="product__items">
                    ...
                    <div className="product__items--content style2 position__relative">
                      ...
                      <h3 className="product__items--content__title h4">
                        <Link href="product-details">Fashion Chair</Link>
                      </h3>
                      <div className="product__items--price style2">
                        <span className="current__price style2">$150.00</span>
                        <span className="old__price style2">$200.00</span>
                      </div>
                      <Link
                        className="product__cart--btn__style2 primary__btn"
                        href="cart"
                      >
                        {" "}
                        Add to cart{" "}
                  ...
                  <div className="product__items">
                    <div className="product__items--thumbnail">
                      ...
                      >
                        <img
                          className="product__items--img product__primary--img"
                          src="/img/product/product3.webp"
                          alt="product-img"
                        />
                        <img
                          className="product__items--img product__secondary--img"
                          src="/img/product/product4.webp"
                          alt="product-img"
                        />
                     </Link>
                      <ul className="product__items--action d-flex justify-content-center">
                    ...
                    <div className="product__items--content style2 position__relative">
                      ...
                      <h3 className="product__items--content__title h4">
                        <Link href="product-details">Globe Electric</Link>
                      </h3>
                      <div className="product__items--price style2">
                        <span className="current__price style2">$160.00</span>
                        <span className="old__price style2">$210.00</span>
                      </div>
                      <Link
                        className="product__cart--btn__style2 primary__btn"
                        href="cart"
                  ...
                  <div className="product__items">
                    <div className="product__items--thumbnail">
                      ...
                      >
                        <img
                          className="product__items--img product__primary--img"
                          src="/img/product/product5.webp"
                          alt="product-img"
                        />
                        <img
                          className="product__items--img product__secondary--img"
                          src="/img/product/product6.webp"
                          alt="product-img"
                        />
                     </Link>
                      <div className="product__badge">
                    ...
                    <div className="product__items--content style2 position__relative">
                      ...
                      <h3 className="product__items--content__title h4">
                        <Link href="product-details">Swivel Chair</Link>
                      </h3>
                      <div className="product__items--price style2">
                        <span className="current__price style2">$165.00</span>
                        <span className="old__price style2">$190.00</span>
                      </div>
                      <Link
                        className="product__cart--btn__style2 primary__btn"
                        href="cart"
                  ...
                  <div className="product__items">
                    <div className="product__items--thumbnail">
                      ...
                      >
                        <img
                          className="product__items--img product__primary--img"
                          src="/img/product/product7.webp"
                          alt="product-img"
                        />
                        <img
                          className="product__items--img product__secondary--img"
                          src="/img/product/product8.webp"
                          alt="product-img"
                        />
                     </Link>
                      <ul className="product__items--action d-flex justify-content-center">
                    ...
                    <div className="product__items--content style2 position__relative">
                      ...
                      <div className="product__items--price style2">
                        <span className="current__price style2">$175.00</span>
                        <span className="old__price style2">$215.00</span>
                      </div>
                      <Link
                        className="product__cart--btn__style2 primary__btn"
                        href="cart"
                  ...
                  <div className="product__items">
                    <div className="product__items--thumbnail">
                      ...
                      >
                        <img
                          className="product__items--img product__primary--img"
                          src="/img/product/product9.webp"
                          alt="product-img"
                        />
                        <img
                          className="product__items--img product__secondary--img"
                          src="/img/product/product10.webp"
                          alt="product-img"
                        />
                     </Link>
                      <div className="product__badge">
                    ...
                    <div className="product__items--content style2 position__relative">
                      ...
                      <h3 className="product__items--content__title h4">
                        <Link href="product-details">Folding Tables</Link>
                      </h3>
                      <div className="product__items--price style2">
                        <span className="current__price style2">$145.00</span>
                        <span className="old__price style2">$180.00</span>
                      </div>
                      <Link
                        className="product__cart--btn__style2 primary__btn"
                        href="cart"
                  ...
                  <div className="product__items">
                    <div className="product__items--thumbnail">
                      ...
                      >
                        <img
                          className="product__items--img product__primary--img"
                          src="/img/product/product11.webp"
                          alt="product-img"
                        />
                        <img
                          className="product__items--img product__secondary--img"
                          src="/img/product/product12.webp"
                          alt="product-img"
                        />
                     </Link>
                      <ul className="product__items--action d-flex justify-content-center">
                    ...
                    <div className="product__items--content style2 position__relative">
                      ...
                      <h3 className="product__items--content__title h4">
                        <Link href="product-details">Tables Chairs</Link>
                      </h3>
                      <div className="product__items--price style2">
                        <span className="current__price style2">$170.00</span>
                        <span className="old__price style2">$220.00</span>
                      </div>
                      <Link
                        className="product__cart--btn__style2 primary__btn"
                        href="cart"
                ...
                <div className="col d-xl-none d-xxl-block mb-25">
                  <div className="product__items">
                    <div className="product__items--thumbnail">
                      <Link
                        className="product__items--link"
                      ...
                      >
                        <img
                          className="product__items--img product__primary--img"
                          src="/img/product/product13.webp"
                          alt="product-img"
                        />
                        <img
                          className="product__items--img product__secondary--img"
                          src="/img/product/product14.webp"
                          alt="product-img"
                        />
                     </Link>
                      <div className="product__badge">
                    ...
                    <div className="product__items--content style2 position__relative">
                      ...
                      <h3 className="product__items--content__title h4">
                        <Link href="product-details">Fabric Chair</Link>
                      </h3>
                      <div className="product__items--price style2">
                        <span className="current__price style2">$178.00</span>
                        <span className="old__price style2">$198.00</span>
                      </div>
                      <Link
                        className="product__cart--btn__style2 primary__btn"
                        href="cart"
                  ...
                  <div className="product__items">
                    <div className="product__items--thumbnail">
                      ...
                      >
                        <img
                          className="product__items--img product__primary--img"
                          src="/img/product/product15.webp"
                          alt="product-img"
                        />
                        <img
                          className="product__items--img product__secondary--img"
                    ...
                    <div className="product__items--content style2 position__relative">
                      ...
                      <div className="product__items--price style2">
                        <span className="current__price style2">$168.00</span>
                        <span className="old__price style2">$212.00</span>
                      </div>
                      <Link
                        className="product__cart--btn__style2 primary__btn"
                        href="cart"
        ...
        <div className="col-xl-4 offset-xl-0 col-lg-6 offset-lg-3 col-md-8  product__col--width__4">
          <div className="deals__banner--thumbnail">
            <Link
              className="deals__banner--thumbnail__link display-block position__relative"
              href="shop"
            >
              <img
                className="deals__banner--thumbnail__img display-block"
                src="/img/banner/banner9.webp"
                alt="deals-thumbnail-img"
              />
              <div className="deals__banner--content text-center">
                <h2 className="deals__banner--content__maintitle h3">
                  Bring Beauty With <br />
                  Furniture Tree{" "}
                </h2>
                <div
                  className="deals__banner--countdown d-flex justify-content-center"
